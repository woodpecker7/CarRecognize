...
public class Intelligence {
    ...
    public Intelligence(boolean enableReportGeneration,FileInputStream fis) throws Exception {
    	configurator=new Configurator(fis);
    ...
    public Intelligence(boolean enableReportGeneration,String propertyFilePath) throws Exception {
    	if(propertyFilePath!=null&&!propertyFilePath.isEmpty()){
    	configurator=new Configurator(propertyFilePath);
    	}
    	else{
    		String file=example.class.getClassLoader().getResource("").getPath()+"config.xml";
    		 file=neu.iot.zhj.example.class.getResource("/config.xml").getPath();
//    		System.out.println("file = "+file);
    	configurator=new Configurator(file);
//    	configurator=new Configurator("."+File.separator+"config.xml");
    	}
